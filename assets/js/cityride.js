(function ($) {
  ...
  function thmOwlInit() {
    // owl slider
    let cityrideowlCarousel = $(".cityride-owl__carousel");
    ...
    let cityrideowlCarouselNav = $(".cityride-owl__carousel--custom-nav");
    ...
    let cityrideowlCarouselWithCounter = $(
      ".cityride-owl__carousel--with-counter"
    );
    if (cityrideowlCarouselWithCounter.length) {
      cityrideowlCarouselWithCounter.each(function () {
        let elm = $(this);
        let options = elm.data("owl-options");
        ...
        elm
          .on("initialized.owl.carousel", function (event) {
            ...
            elm.append(
              '<div class="cityride-owl__carousel__counter"><span class="cityride-owl__carousel__counter__total"></span> <span class="cityride-owl__carousel__counter__current"></span></div>'
            );
            elm
              .find(".cityride-owl__carousel__counter__current")
              .text(
                addLeadingZero(carousel.relative(carousel.current()) + 1, 2)
              );
            elm
              .find(".cityride-owl__carousel__counter__total")
  ...
  function cityride_stretch() {
    var i = $(window).width();
    $(".row .cityride-stretch-element-inside-column").each(function () {
      var $this = $(this),
  ...
  function cityride_cuved_circle() {
